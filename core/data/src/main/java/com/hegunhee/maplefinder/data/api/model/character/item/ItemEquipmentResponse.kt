...
data class ItemEquipmentResponse(
    ...
    @SerialName("scroll_resilience_count")val scrollRecoverableCount: String,
    @SerialName("scroll_upgrade")val scrollUpgradeCount: String,
    ...
    @SerialName("item_total_option")val totalOption: ItemOptionResponse,
    @SerialName("item_base_option")val baseOption: ItemOptionResponse,
    @SerialName("item_add_option")val addOption: ItemOptionResponse,
    @SerialName("item_etc_option")val etcOption: ItemOptionResponse,
    @SerialName("item_exceptional_option")val exceptionalOption: ItemOptionResponse,
    @SerialName("item_starforce_option")val starforceOption: ItemOptionResponse,
